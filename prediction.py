...
class Predictor:
    ...
    def __init__(self, model, window_size, n_features, pred_args, summary_file_name="summary.txt"):
        ...
        self.group = pred_args["data_group"]
        self.batch_size = 256
        self.use_cuda = True
    ...
    def predict_anomalies(self, train, test, true_anomalies, load_scores=False, save_output=True,
        ...
        if flag == 'MSL':
            ...
            with open(f"output/MSL/f1.txt", "a") as f:
                f.write(f"{self.group}:\t"
                        + f"epsilon_result: {summary['epsilon_result']['f1']}"
                        + f"\tpot_result: {summary['pot_result']['f1']}"
                        + f"\tbf_result: {summary['bf_result']['f1']}"
                        + f"\tepoch: {epochs}\n")
        elif flag == 'SMAP':
            with open(f"output/SMAP/f1.txt", "a") as f:
                f.write(f"{self.group}:\t"
                        + f"epsilon_result: {summary['epsilon_result']['f1']}"
                        + f"\tpot_result: {summary['pot_result']['f1']}"
                        + f"\tbf_result: {summary['bf_result']['f1']}"
            ...
            with open(f"output/SMD/f1.txt", "a") as f:
                f.write(f"{self.group}:\t"
                        + f"epsilon_result: {summary['epsilon_result']['f1']}"
                        + f"\tpot_result: {summary['pot_result']['f1']}"
                        + f"\tbf_result: {summary['bf_result']['f1']}"
            ...
            with open(f"output/WADI/f1.txt", "a") as f:
                f.write(f"f1:\t"
                        + f"epsilon_result: {summary['epsilon_result']['f1']}"
                        + f"\tpot_result: {summary['pot_result']['f1']}"
                        + f"\tbf_result: {summary['bf_result']['f1']}"
            ...
            with open(f"output/SWaT/f1.txt", "a") as f:
                f.write(f"f1:\t"
                        + f"epsilon_result: {summary['epsilon_result']['f1']}"
                        + f"\tpot_result: {summary['pot_result']['f1']}"
                        + f"\tbf_result: {summary['bf_result']['f1']}"
            ...
            with open(f"output/PSM/f1.txt", "a") as f:
                f.write(f"f1:\t"
                        + f"epsilon_result: {summary['epsilon_result']['f1']}"
                        + f"\tpot_result: {summary['pot_result']['f1']}"
                        + f"\tbf_result: {summary['bf_result']['f1']}"
