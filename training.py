...
class Trainer:
    ...
    def fit(self, train_loader, val_loader=None):
        ...
        for epoch in range(self.n_epochs):
            ...
            pbar = tqdm(train_loader, desc=f'Epoch {epoch + 1}/{self.n_epochs}', unit='batch') 
            for x, y in pbar:  
                x = x.to(self.device)
                y = y.to(self.device)
                ...
                pbar.set_postfix(loss=loss / len(train_loader))    
    ...
    def evaluate(self, data_loader): 
        ...
        with torch.no_grad():  
            ...
            for x, y in pbar:  
                ...
                pbar.set_postfix(loss=forecast_loss+recon_loss) 
